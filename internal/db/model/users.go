...
var UserWhere = struct {
	...
	ID:        whereHelperstring{field: "\"kgames\".\"users\".\"id\""},
	Name:      whereHelperstring{field: "\"kgames\".\"users\".\"name\""},
	Email:     whereHelperstring{field: "\"kgames\".\"users\".\"email\""},
	Locale:    whereHelperstring{field: "\"kgames\".\"users\".\"locale\""},
	CreatedAt: whereHelpertime_Time{field: "\"kgames\".\"users\".\"created_at\""},
	UpdatedAt: whereHelpertime_Time{field: "\"kgames\".\"users\".\"updated_at\""},
}

// UserRels is where relationship names are stored.
var UserRels = struct {
	BatterGameMoves   string
	StrikerGameMoves  string
	PlayerGamePlayers string
}{
	BatterGameMoves:   "BatterGameMoves",
	StrikerGameMoves:  "StrikerGameMoves",
	PlayerGamePlayers: "PlayerGamePlayers",
}

// userR is where relationships are stored.
type userR struct {
	BatterGameMoves   GameMoveSlice   `boil:"BatterGameMoves" json:"BatterGameMoves" toml:"BatterGameMoves" yaml:"BatterGameMoves"`
	StrikerGameMoves  GameMoveSlice   `boil:"StrikerGameMoves" json:"StrikerGameMoves" toml:"StrikerGameMoves" yaml:"StrikerGameMoves"`
	PlayerGamePlayers GamePlayerSlice `boil:"PlayerGamePlayers" json:"PlayerGamePlayers" toml:"PlayerGamePlayers" yaml:"PlayerGamePlayers"`
}
...
func (r *userR) GetBatterGameMoves() GameMoveSlice {
	if r == nil {
		return nil
	}
	return r.BatterGameMoves
}

func (r *userR) GetStrikerGameMoves() GameMoveSlice {
	if r == nil {
		return nil
	}
	return r.StrikerGameMoves
}

func (r *userR) GetPlayerGamePlayers() GamePlayerSlice {
	if r == nil {
		return nil
	}
	return r.PlayerGamePlayers
}
...
var (
	userAllColumns            = []string{"id", "name", "email", "locale", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"name", "email", "locale"}
...
// BatterGameMoves retrieves all the game_move's GameMoves with an executor via batter_id column.
func (o *User) BatterGameMoves(mods ...qm.QueryMod) gameMoveQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"kgames\".\"game_moves\".\"batter_id\"=?", o.ID),
	)

	return GameMoves(queryMods...)
}

// StrikerGameMoves retrieves all the game_move's GameMoves with an executor via striker_id column.
func (o *User) StrikerGameMoves(mods ...qm.QueryMod) gameMoveQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"kgames\".\"game_moves\".\"striker_id\"=?", o.ID),
	)

	return GameMoves(queryMods...)
}

// PlayerGamePlayers retrieves all the game_player's GamePlayers with an executor via player_id column.
func (o *User) PlayerGamePlayers(mods ...qm.QueryMod) gamePlayerQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"kgames\".\"game_players\".\"player_id\"=?", o.ID),
	)

	return GamePlayers(queryMods...)
}

// LoadBatterGameMoves allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadBatterGameMoves(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`kgames.game_moves.batter_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.BatterGameMoves = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &gameMoveR{}
			}
			foreign.R.Batter = object
		}
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.BatterID {
				local.R.BatterGameMoves = append(local.R.BatterGameMoves, foreign)
				if foreign.R == nil {
					foreign.R = &gameMoveR{}
				}
				foreign.R.Batter = local
				break
			}
		}
	}
...
// LoadStrikerGameMoves allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadStrikerGameMoves(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`kgames.game_moves`),
		qm.WhereIn(`kgames.game_moves.striker_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.StrikerGameMoves = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &gameMoveR{}
			}
			foreign.R.Striker = object
		}
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.StrikerID {
				local.R.StrikerGameMoves = append(local.R.StrikerGameMoves, foreign)
				if foreign.R == nil {
					foreign.R = &gameMoveR{}
				}
				foreign.R.Striker = local
				break
			}
		}
	}
...
// LoadPlayerGamePlayers allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadPlayerGamePlayers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`kgames.game_players.player_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.PlayerGamePlayers = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.PlayerID {
				local.R.PlayerGamePlayers = append(local.R.PlayerGamePlayers, foreign)
				if foreign.R == nil {
					foreign.R = &gamePlayerR{}
				}
...
// AddBatterGameMoves adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.BatterGameMoves.
// Sets related.R.Batter appropriately.
func (o *User) AddBatterGameMoves(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*GameMove) error {
	var err error
	...
	if o.R == nil {
		o.R = &userR{
			BatterGameMoves: related,
		}
	} else {
		o.R.BatterGameMoves = append(o.R.BatterGameMoves, related...)
	}
...
// AddStrikerGameMoves adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.StrikerGameMoves.
// Sets related.R.Striker appropriately.
func (o *User) AddStrikerGameMoves(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*GameMove) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.StrikerID = o.ID
	...
	if o.R == nil {
		o.R = &userR{
			StrikerGameMoves: related,
		}
	} else {
		o.R.StrikerGameMoves = append(o.R.StrikerGameMoves, related...)
	}
...
// AddPlayerGamePlayers adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.PlayerGamePlayers.
// Sets related.R.Player appropriately.
func (o *User) AddPlayerGamePlayers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*GamePlayer) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.PlayerID = o.ID
	...
	if o.R == nil {
		o.R = &userR{
			PlayerGamePlayers: related,
		}
	} else {
		o.R.PlayerGamePlayers = append(o.R.PlayerGamePlayers, related...)
	}
...
func Users(mods ...qm.QueryMod) userQuery {
	mods = append(mods, qm.From("\"kgames\".\"users\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"kgames\".\"users\".*"})
	}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*User, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"kgames\".\"users\" where \"id\"=$1", sel,
	)
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"kgames\".\"users\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"kgames\".\"users\" %sDEFAULT VALUES%s"
		}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"kgames\".\"users\" SET %s WHERE %s",
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"kgames\".\"users\" SET %s WHERE %s",
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"kgames\".\"users\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"kgames\".\"users\" WHERE \"id\"=$1"
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"kgames\".\"users\" WHERE " +
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"kgames\".\"users\".* FROM \"kgames\".\"users\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, userPrimaryKeyColumns, len(*o))
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"kgames\".\"users\" where \"id\"=$1 limit 1)"
